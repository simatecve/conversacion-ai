  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-lg text-sm font-medium ring-offset-background transition-all duration-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        ...
        gradient: "bg-gradient-primary text-white hover:opacity-90 shadow-glow hover:shadow-xl transform hover:scale-105",
        "gradient-hero": "bg-gradient-hero text-white hover:opacity-90 shadow-glow hover:shadow-xl transform hover:scale-105",
        "glass": "bg-background/80 backdrop-blur-sm border border-border/50 hover:bg-background/90 hover:border-primary/50",
      },
      size: {
